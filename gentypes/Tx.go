...
func (rcv *Tx) MutateHeight(n uint64) bool {
...
func TxAddHeight(builder *flatbuffers.Builder, Height uint64) {
	builder.PrependUint64Slot(7, Height, 0)
}
