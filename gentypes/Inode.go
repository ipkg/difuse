...
func (rcv *Inode) BlockSize() int32 {
...
func (rcv *Inode) MutateBlockSize(n int32) bool {
...
func InodeAddBlockSize(builder *flatbuffers.Builder, BlockSize int32) {
	builder.PrependInt32Slot(4, BlockSize, 0)
}
